...
vgg = VGG16(include_top=False, weights='imagenet', input_shape=(train_height, train_width, 3))
vgg.trainable = False
...
def load_images(path, img_size=(256, 256), max_images=None):
    images = []
    filenames = []
...
input_images, input_filenames = load_images(input_images_path)
print("Finished loading DNxHQ images.")
output_images, output_filenames = load_images(output_images_path)
...
model = unet_model(input_size=(train_height, train_width, 3))
